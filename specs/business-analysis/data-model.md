...
| dharmaKarmadhipati | Yoga | Dharma Karmadhipati Yoga | ධර්ම කර්මාධිපති යෝගය | Parashara (Mainstream, `docs/parashara-yoga.md` overrides `docs/dharma-karmadhipati-yogaya.md`) | DK-01 9th/10th lords conjunction (1); DK-02 mutual drishti (2); DK-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — member of the Parashara sambandha family; same-lord exclusion (a reference whose 9th/10th signs share one lord never forms it) |
| pushkala | Yoga | Pushkala Yoga | පුෂ්කල යෝගය | Parashara (Mainstream) | PS-01 1st/2nd lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 1-2; same-lord exclusion |
| rajaChitta | Yoga | Raja Chitta Yoga | රාජ චිත්ත යෝගය | Parashara (Mainstream) | PS-01 2nd/3rd lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 2-3; same-lord exclusion |
| champaka | Yoga | Champaka Yoga | චම්පක යෝගය | Parashara (Mainstream) | PS-01 3rd/4th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 3-4; same-lord exclusion |
| amathya | Yoga | Amathya Yoga | අමාත්‍ය යෝගය | Parashara (Mainstream) | PS-01 4th/5th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 4-5 (doc's "5-6" mislabel corrected per domain); same-lord exclusion |
| dharukaKarma | Yoga | Dharuka Karma Yoga | ධාරුක කර්ම යෝගය | Parashara (Mainstream) | PS-01 5th/6th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 5-6; same-lord exclusion |
| priyamrityu | Yoga | Priyamrityu Yoga | ප්‍රියමෘත්‍ය යෝගය | Parashara (Mainstream) | PS-01 6th/7th or 7th/8th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — either house pair forms it; same-lord exclusion |
| bhagyaVyaya | Yoga | Bhagya Vyaya Yoga | භාග්‍ය වැය යෝගය | Parashara (Mainstream) | PS-01 8th/9th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 8-9; same-lord exclusion |
| bhumiDravya | Yoga | Bhumi Dravya Yoga | භූමි ද්‍රව්‍ය යෝගය | Parashara (Mainstream) | PS-01 10th/11th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 10-11; same-lord exclusion |
| rinaVyaya | Yoga | Rina Vyaya Yoga | ඍණ වැය යෝගය | Parashara (Mainstream) | PS-01 11th/12th lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 11-12; same-lord exclusion |
| chittaHani | Yoga | Chitta Hani Yoga | චිත්ත හානි යෝගය | Parashara (Mainstream) | PS-01 12th/1st lords conjunction (1); PS-02 mutual drishti (2); PS-03 parivartana (1) — lord pairs from Lagna, Moon and Sun | Active — houses 12-1; same-lord exclusion |

**Parashara sambandha family:** the ten yogas above plus dharmaKarmadhipati form the Parashara family (`docs/parashara-yoga.md`). Every member connects two ADJACENT house lords through one of three sambandhas — conjunction, mutual aspect, or parivartana — with lordships evaluated from **three references** (Lagna, then Moon, then Sun; the first reference that yields a connection fires). A yoga **never forms when one planet rules both houses** (e.g. Saturn owns Makara/Kumbha, so a reference whose pair falls on Capricorn/Aquarius is excluded). Feature search groups the whole family under "Parashara yoga".
...
- `yogaDoshaVersion` stamps the writer version (currently `11`); legacy documents stored under older versions recompute their `yogas`/`doshas` from chart facts at render/search (the resolver reads chart planets + houses + aspects + nakshatra lordship)
