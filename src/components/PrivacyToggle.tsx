        ...
        >
            <div role="radiogroup" aria-label={t("horoscope.privacy.title")} className="space-y-2">
                ...
                >
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            {t("horoscope.privacy.private_description")}
                        </p>
                    </div>
                </label>
                ...
                >
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            {t("horoscope.privacy.public_description")}
                        </p>
                    </div>
                </label>
            </div>
            ...
            >
                <div role="radiogroup" aria-label={t("horoscope.privacy.display_name_title")} className="space-y-2">
                    <p className="text-sm font-medium text-gray-700 mb-2">{t("horoscope.privacy.display_name_title")}</p>
            ...
            {context === 'detail' && (
                <p className="text-xs text-gray-400 mt-3">
                    {t("horoscope.privacy.share_link_note")}
                </p>
            )}
        </div>
    );
