...
export const YOGA_CATALOG: YogaCatalogEntry[] = [
    ...
    },
    {
        ...
        tradition: "MAIN_STREAM",
        status: "ACTIVE",
        keywordEn: "Dhana Yoga",
        keywordSi: "ධන යෝගය",
        searchAliasesEn: ["Dhana", "Dhana Yoga", "Dhana Yogaya", "Wealth yoga", "2nd 5th 9th 11th lords"],
        searchAliasesSi: ["ධන යෝග", "ධන යෝගය"],
        i18nKey: "yoga.dhanaYoga",
        planets: [1, 2, 3, 4, 5, 6, 7, 8, 9],
        expressionKeys: ["expression.main"],
        rules: [
            { rule: "dhanaYoga.dh01", strength: 1, reasonKey: "rule.dh01" },
            { rule: "dhanaYoga.dh02", strength: 2, reasonKey: "rule.dh02" },
            { rule: "dhanaYoga.dh03", strength: 1, reasonKey: "rule.dh03" },
        ],
        mitigations: [],
    },
    {
        ...
        tradition: "MAIN_STREAM",
        status: "ACTIVE",
        keywordEn: "Neecha Raja Yoga",
        keywordSi: "නීච රාජ යෝගය",
        searchAliasesEn: ["Neecha Raja", "Debilitated Raja", "Neecha Rajayoga", "Debilitated planet upachaya"],
        searchAliasesSi: ["නීච රාජ", "නීචරාජ", "නීච රාජ යෝග"],
        i18nKey: "yoga.neechaRajaYoga",
        planets: [1, 2, 3, 4, 5, 6, 7],
        expressionKeys: ["expression.main"],
        rules: [{ rule: "neechaRajaYoga.nr01", strength: 2, reasonKey: "rule.nr01" }],
        mitigations: [],
    },
];
