                  ...
                  {tab === "horoscopes" ? (
                    <>
                      <td className="px-4 py-2">
                        <Link href={`/horoscopes/${item._id}`} className="text-indigo-600 hover:underline">
                          {item.name as string}
                        </Link>
                      </td>
                      <td className="px-4 py-2 text-gray-500">{(item.owner as { id?: string })?.id?.slice(-6)}</td>
                      <td className="px-4 py-2">
                        <span className={`text-xs px-1.5 py-0.5 rounded ${item.isPublic ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}>
                    ...
                    <>
                      ...
                      <td className="px-4 py-2 text-gray-500">{item.preferredLanguage as string}</td>
                    </>
                  )}
                </tr>
              ))}
